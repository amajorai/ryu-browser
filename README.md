...
The desktop Browser panel sends the resolved Desktop appearance snapshot to the
sidecar shell. Its colors, fonts, locale, and display time zone update live
without changing the browser profile or the appearance of pages opened in tabs.
...
<a href="https://github.com/amajorai/ryu-browser/stargazers">
  <picture>
