...
// manifest ships 20 `runnables` (`chromium.list_tabs`, `chromium.open_tab`,
// `chromium.snapshot_tab`, `chromium.list_webmcp_tools`, …) covering every tab,
// input, capture, annotation, and WebMCP route this sidecar serves, and they are
// strictly better than anything a derivation could produce:
//
...
//
// Re-deriving those same 20 operations from this document would put a second,
...
//   POST /tabs/{id}/context · GET /tabs/{id}/webmcp ·
//   POST /tabs/{id}/webmcp/execute · POST /tabs/{id}/annotations ·
//   POST /click · POST /type · POST /scroll · POST /hover · POST /click-at ·
//   POST /key · POST /drag
//
...
// costs, the same way the other 20 were added.
//
